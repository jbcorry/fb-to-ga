...
;(function( $ ) {
  ...
  messages = {
    ...
    email     : 'Error: Your E-mail address appears to be invalid.',
    number    : 'Error: You can enter only numbers in this field.',
    maxLength : 'Error: Maximum {count} characters allowed.',
    minLength : 'Error: Minimum {count} characters allowed.',
    maxChecked  : 'Error: Maximum {count} options allowed. Please be sure to check.',
    minChecked  : 'Error: Please select minimum {count} options.',
    maxSelected : 'Error: Maximum {count} selection allowed. Please be sure to check.',
    minSelected : 'Error: Minimum {count} selection allowed. Please be sure to check.',
    notEqual    : 'Error: Fields do not match. Please be sure to check.',
    different   : 'Error: Fields cannot be the same as each other',
    creditCard  : 'Error: Invalid credit card number. Please be sure to check.'
  },
